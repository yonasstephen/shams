...
def test_compute_player_stats_last_game(mock_fetch):
    ...
    stats = player_stats.compute_player_stats(
        player_id, "2024-25", "last", season_start, today, agg_mode="avg"
    )
...
def test_compute_player_stats_last_n_games(mock_fetch):
    ...
    stats = player_stats.compute_player_stats(
        player_id, "2024-25", "last3", season_start, today, agg_mode="avg"
    )
...
def test_compute_player_stats_sum_mode(mock_fetch):
    ...
    stats = player_stats.compute_player_stats(
        player_id, "2024-25", "last2", season_start, today, agg_mode="sum"
    )
...
def test_compute_player_stats_last_n_days(mock_fetch):
    ...
    stats = player_stats.compute_player_stats(
        player_id, "2024-25", "last7d", season_start, today, agg_mode="avg"
    )
...
def test_compute_player_stats_no_games(mock_fetch):
    ...
    stats = player_stats.compute_player_stats(player_id, "2024-25", "last", season_start, today)
