...
def test_compute_player_stats_last_game(mock_fetch):
    ...
    stats = player_stats.compute_player_stats(
        player_id, "last", season_start, today, agg_mode="avg", season="2024-25"
    )
...
def test_compute_player_stats_last_n_games(mock_fetch):
    ...
    stats = player_stats.compute_player_stats(
        player_id, "last3", season_start, today, agg_mode="avg", season="2024-25"
    )
...
def test_compute_player_stats_sum_mode(mock_fetch):
    ...
    stats = player_stats.compute_player_stats(
        player_id, "last2", season_start, today, agg_mode="sum", season="2024-25"
    )
...
def test_compute_player_stats_last_n_days(mock_fetch):
    ...
    stats = player_stats.compute_player_stats(
        player_id, "last7d", season_start, today, agg_mode="avg", season="2024-25"
    )
...
def test_compute_player_stats_no_games(mock_fetch):
    ...
    stats = player_stats.compute_player_stats(player_id, "last", season_start, today, season="2024-25")
